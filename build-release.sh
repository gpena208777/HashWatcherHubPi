...
echo "  ./build-deb.sh 1.0.11"
echo ""
echo "Upload both to the public repo:"
echo "  gh release create v1.0.11 ${OUT} hashwatcher-hub-pi_1.0.11_all.deb --repo gpena208777/HashWatcherHubPi --title 'v1.0.11' --notes 'HashWatcher Hub Pi v1.0.11'"
