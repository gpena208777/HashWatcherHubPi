...
echo "  ./build-deb.sh 1.0.0"
echo ""
echo "Upload both to the public repo:"
echo "  gh release create v1.0.0 ${OUT} hashwatcher-hub-pi_1.0.0_all.deb --repo gpena208777/HashWatcherHubPi --title 'v1.0.0' --notes 'HashWatcher Hub Pi v1.0.0'"
